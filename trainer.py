...
def train_model(dataset_sizes, dataloaders, model, criterion, optimizer, scheduler, num_epochs=25, device='cpu'):
    ...
    with TemporaryDirectory() as tempdir:
        ...
        torch.save(model.state_dict(), best_model_params_path) #saves the best model state found, including all it's parameters and buffers , in a file in provided path
        best_acc = 0.0
